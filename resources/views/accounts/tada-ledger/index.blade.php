...
@section('title', 'TA/DA Ledger')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box flex_btn">
            <h4 class="page-title">TA/DA Ledger</h4>
        </div>
    </div>
</div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Reject TA/DA Claim</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="reject-form">
                    <div class="form-group">
                        ...
                        <span class="text-danger error-text rejection_reason_error"></span>
                    </div>
                    <div class="form-group">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.view-claim', function() {
        var id = $(this).data('id');
        var viewUrl = "{{ route('accounts.tada.show', ':id') }}";
    ...
    $(document).on('click', '.approve-claim-btn', function(e) {
        ...
        var url = "{{ route('accounts.tada.approve', ':id') }}";   
    ...
    $('#reject-form').on('submit', function(e) {
        ...
        var url = "{{ route('accounts.tada.reject', ':id') }}";   
        var url = url.replace(':id', currentClaimId);
        $.ajax({
            url: url,
            type: 'POST',
            data: {
