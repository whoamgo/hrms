...
$(document).ready(function() {
    ...
    $('#filter_employee_id').on('input', function() {
        ...
        $input.data('timeout', setTimeout(function() {
            if (employeeIdCache[term]) {
                ...
                $.ajax({
                    url: '{{ route("admin.employees.autocomplete.employee-id") }}',
                    data: { term: term },
    ...
    $('#filter_name').on('input', function() {
        ...
        $input.data('timeout', setTimeout(function() {
            if (nameCache[term]) {
                ...
                $.ajax({
                    url: '{{ route("admin.employees.autocomplete.name") }}',
                    data: { term: term },
                    success: function(data) {
                        nameCache[term] = data;
                        showAutocomplete($input, data);
    ...
    $('#filter_department').on('input', function() {
        ...
        $input.data('timeout', setTimeout(function() {
            if (departmentCache[term]) {
                ...
                $.ajax({
                    url: '{{ route("admin.employees.autocomplete.department") }}',
                    data: { term: term },
                    success: function(data) {
    ...
    var employeeViewUrl = "{{ route('admin.employees.show', ':id') }}";
