<button class="btn waves-effect waves-light btn-sm btn-info view-contract-history" data-id="{{ $employee->getRouteKey() }}" data-toggle="tooltip" data-placement="top" title="View History">
    <i class="ti-eye"></i>
</button>
