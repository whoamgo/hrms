...
<div class="row">
    <div class="col-12">
        <div class="page-title-box flex_btn">
            ...
            <a href="{{ route('hr.attendances.create') }}" class="btn btn-primary">Add Attendance</a>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('#filter_employee_id').on('input', function() {
        ...
        $input.data('timeout', setTimeout(function() {
            if (nameCache[term]) {
                ...
                $.ajax({
                    url: '{{ route("hr.attendances.autocomplete.employee-name") }}',
                    data: { term: term },
    ...
    $(document).on('click', '.view-attendance', function() {
        ...
        var viewUrl = "{{ route('hr.attendances.show', ':id') }}";
    ...
    $('#confirmDeleteAttendance').on('click', function() {
        if (deleteAttendanceId) {
            ...
            var deleteViewUrl = "{{ route('hr.attendances.show', ':id') }}";
