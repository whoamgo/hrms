...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <form id="attendance-form" action="{{ route('hr.attendances.update', $attendance) }}" method="POST" data-ajax-form>
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <a href="{{ route('hr.attendances.index') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
