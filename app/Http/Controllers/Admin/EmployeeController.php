...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('admin.employees.index', compact('departments', 'employeeTypes', 'roles'));
        } catch (\Exception $e) {
        ...
        try {
            ...
            foreach ($employees as $employee) {
                $data[] = [
                    ...
                    'actions' => view('admin.employees.partials.actions', ['employee' => $employee])->render(),
                ];
            }
    ...
    public function create()
    {
        try {
            ...
            return redirect()->route('admin.employees.index')->with('error', 'Error loading form: ' . $e->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            try {
                ...
                $userId = $user->id;
                \App\Helpers\ActivityLogHelper::log('created', $user, "Created user for employee: {$request->full_name}");
                ...
                \App\Helpers\ActivityLogHelper::log('created', $employee, "Created employee: {$employee->full_name}");
    ...
    public function show(Employee $employee, Request $request)
    {
        try {
            ...
            if ($request->ajax()) {
                return view('admin.employees.partials.view-modal', compact('employee'))->render();
            }
            ...
            return redirect()->route('admin.employees.index')->with('error', 'Error loading employee: ' . $e->getMessage());
        }
    }
    ...
    public function update(Request $request, Employee $employee)
    {
        try {
            ...
            \App\Helpers\ActivityLogHelper::log('updated', $employee, "Updated employee: {$employee->full_name}", $oldValues, $employee->toArray());
    ...
    public function destroy(Employee $employee)
    {
        try {
            ...
            // Delete user if exists (cascade delete)
            if ($userId) {
                $user = User::find($userId);
                if ($user) {
                    $user->delete();
                    \App\Helpers\ActivityLogHelper::log('deleted', null, "Deleted user for employee: {$employeeName}");
                }
            }

            \App\Helpers\ActivityLogHelper::log('deleted', null, "Deleted employee: {$employeeName}");
