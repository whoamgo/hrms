...
class AttendanceController extends Controller
{
    public function index()
    {
        try {
            ...
            \App\Helpers\ActivityLogHelper::log('viewed', null, 'HR - Attendance Management');
        ...
        try {
            ...
            foreach ($attendances as $attendance) {
                ...
                $data[] = [
                    ...
                    'actions' => view('hr.attendances.partials.actions', ['attendance' => $attendance])->render(),
                ];
            }
    ...
    public function create()
    {
        try {
            ...
            return redirect()->route('hr.attendances.index')->with('error', 'Error loading form: ' . $e->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('hr.attendances.index')
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function show(Attendance $attendance, Request $request)
    {
        try {
            ...
            if ($request->ajax()) {
                return view('hr.attendances.partials.view-modal', compact('attendance'))->render();
            }
            ...
            return redirect()->route('hr.attendances.index')->with('error', 'Error loading attendance: ' . $e->getMessage());
        }
    }
